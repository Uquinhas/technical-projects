<?php 
	...
	$sql = "INSERT INTO `tb_pagamento`(`tipoPagamento`, `dataPagamento`, `valorPagamento`, `pago`) VALUES ('$tipo', '$data', '$valor', 0)";
	
	if(mysqli_query($con, $sql)){
		
		$local= "\"location.href='/NobreFinanceira/portal/pg_btn_menu/pagamento/pagamento.php'\"";
		echo '
